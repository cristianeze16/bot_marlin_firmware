...
namespace Language_en {
  ...
  PROGMEM Language_Str MSG_ZOFFSET_CALIBRATION_WIZ         = _UxGT("Put a gauge");
  PROGMEM Language_Str MSG_ZOFFSET_CALIBRATION_WIZ_1       = _UxGT("to adjust");
  PROGMEM Language_Str MSG_ZOFFSET_CALIBRATION_WIZ_2       = _UxGT("the distance between");
  PROGMEM Language_Str MSG_ZOFFSET_CALIBRATION_WIZ_3       = _UxGT("nozzle and heatbed");
  PROGMEM Language_Str MSG_ZOFFSET_CALIBRATION_WIZ_6       = _UxGT("Click to continue");
