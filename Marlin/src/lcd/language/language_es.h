...
namespace Language_es {
  ...
  PROGMEM Language_Str MSG_ACCURACY_ACHIEVED               = _UxGT("Precisión alcanzada");
  PROGMEM Language_Str MSG_ITERATION                       = _UxGT("G34 Iteración: %i");
  PROGMEM Language_Str MSG_LEVEL_BED_HOMING                = _UxGT("LLevando al origen ");
   PROGMEM Language_Str MSG_BED_HOMING_WAIT                = _UxGT("por favor espere...");
  ...
  PROGMEM Language_Str MSG_MOVE_NOZZLE_TO_BED              = _UxGT("Mover Z a la cama");
  PROGMEM Language_Str MSG_ZOFFSET_CALIBRATION_WIZ         = _UxGT("Coloque una galga");
  PROGMEM Language_Str MSG_ZOFFSET_CALIBRATION_WIZ_1       = _UxGT("Para ajustar la dis- ");
  PROGMEM Language_Str MSG_ZOFFSET_CALIBRATION_WIZ_2       = _UxGT("-tancia entre el ");
  PROGMEM Language_Str MSG_ZOFFSET_CALIBRATION_WIZ_3       = _UxGT("nozzle y la cama");
  PROGMEM Language_Str MSG_ZOFFSET_CALIBRATION_WIZ_6       = _UxGT("Click para continuar");
  ...
  PROGMEM Language_Str MSG_PROBE_WIZARD                    = _UxGT("Asistente sonda Z");
}
