...
void prepare_for_calibration() {
 ...
 void info_z_wizard() {
 if (ui.use_click()) return ui.goto_screen(probe_offset_wizard_menu);
    START_SCREEN();
    STATIC_ITEM(MSG_ZOFFSET_CALIBRATION_WIZ, SS_DEFAULT|SS_INVERT);             
    STATIC_ITEM(MSG_ZOFFSET_CALIBRATION_WIZ_1);                   
    STATIC_ITEM(MSG_ZOFFSET_CALIBRATION_WIZ_2,SS_DEFAULT);              
    STATIC_ITEM(MSG_ZOFFSET_CALIBRATION_WIZ_3);                 
    STATIC_ITEM(MSG_ZOFFSET_CALIBRATION_WIZ_6,SS_DEFAULT|SS_INVERT);
    END_SCREEN();
   }
// testing
