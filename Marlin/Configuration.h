...
#define CUSTOM_MACHINE_NAME "BOT"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -36, -36, 0 }
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { {  220, 10, (Z_MIN_POS + 1) } }
  #define NOZZLE_CLEAN_END_POINT   { { 220, 100, (Z_MIN_POS + 1) } }
